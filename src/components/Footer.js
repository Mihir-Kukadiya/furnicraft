...
const Footer = () => {
    ...
    return (
        ...
        >
            <Box className="row" sx={{ mb: 5 }}>
                <Box className="col-md-3 col-12 mb-4">
                    <Typography variant="h5" fontWeight="bold" gutterBottom>
                        FurniCraft
                    </Typography>
                    <Typography variant="body2" color="grey.400">
                        Elevate your space with premium furniture that blends style with comfort. Designed to suit every taste and need.
                    </Typography>
                </Box>
                <Box className="col-md-3 col-12 mb-4">
            ...
            >
                ...
                <Box className="col-12 col-sm-6 text-sm-end"
                    sx={{
                        display: "flex",
